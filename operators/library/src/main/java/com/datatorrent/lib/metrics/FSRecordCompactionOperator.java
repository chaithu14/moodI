...
{
  private static final Logger LOG = LoggerFactory.getLogger(FSRecordCompactionOperator.class);
  /**
  ...
  protected void rotate(String fileName) throws IllegalArgumentException, IOException, ExecutionException
  {
    ...
    LOG.info("rotate: {} -> {}", fileName, partFileName);
  ...
  protected void finalizeFile(String fileName) throws IOException
  {
    ...
    LOG.info("finalizeFile: {} -> {}", fileName , fileToTupleCount.get(fileName));
